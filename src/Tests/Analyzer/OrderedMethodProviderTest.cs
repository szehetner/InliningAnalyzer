...
namespace Tests.Analyzer
{
    ...
    public class OrderedMethodProviderTest
    {
        ...
        public void Test()
        {
            ...
            JitRunner runner = new JitRunner(assemblyFile, new JitTarget(TargetPlatform.X64, TargetRuntime.NetFramework, null), new TargetScope(ScopeType.AssemblyFile), new ConsoleLogger(), new TestJitPathResolver(), true);
